...
export function CleanText(arg1) {
  return window['go']['app']['App']['CleanText'](arg1);
}

export function ConfirmIntent(arg1) {
  return window['go']['app']['App']['ConfirmIntent'](arg1);
}
...
export function DismissIntent(arg1) {
  return window['go']['app']['App']['DismissIntent'](arg1);
}
...
export function GetPendingIntents() {
  return window['go']['app']['App']['GetPendingIntents']();
}
...
export function GetSentimentTrend(arg1) {
  return window['go']['app']['App']['GetSentimentTrend'](arg1);
}
...
export function MergeThoughts(arg1) {
  return window['go']['app']['App']['MergeThoughts'](arg1);
}
